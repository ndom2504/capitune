...
function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Sign in error');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // loginWithGoogle() redirects itself, no need for navigate
    } catch (err) {
  ...
  const handleMicrosoftLogin = async () => {
    ...
    try {
      ...
      // loginWithMicrosoft() redirects itself, no need for navigate
    } catch (err) {
    ...
    <div className="auth-page">
      ...
      >
        <div className="auth-header">
          <h1>Welcome to <span className="auth-brand">Capitune</span></h1>
          <p>Where the world speaks together</p>
        </div>
